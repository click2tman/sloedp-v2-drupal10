<?php
function sloedp_2023_base_url(){
  global $base_url;
  $theme_path = \Drupal::service('extension.list.theme')->getPath('sloedp_2023');
  return $base_url . '/' . $theme_path . '/';
}
global $gva_node_index;
function sloedp_2023_preprocess_node(&$variables) {
  global $gva_node_index;
  ...
  $variables['theme_uri'] = base_path() . \Drupal::service('extension.list.theme')->getPath('sloedp_2023');
}

function sloedp_2023_preprocess_node__portfolio(&$variables){
  $node = $variables['node'];
...
function sloedp_2023_preprocess_node__event(&$variables){
  $node = $variables['node'];
  $event_date = array();
...
function sloedp_2023_preprocess_breadcrumb(&$variables){
