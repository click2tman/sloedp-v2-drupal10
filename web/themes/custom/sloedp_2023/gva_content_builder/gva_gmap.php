...
if(!class_exists('element_gva_gmap')):
   class element_gva_gmap{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <script type="text/javascript" src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('sloedp_2023')) ?>/vendor/gmap3.js"></script>
         <script type="text/javascript" src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('sloedp_2023')) ?>/vendor/jquery.ui.map.min.js"></script>
